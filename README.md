...
Grab the latest build (**v3.5.3**) directly or check the [Releases page](https://github.com/abod124-sudo/Radium-Launcher/releases/latest):

| File | Description |
|------|-------------|
| [Radium.Launcher_3.5.3_x64-setup.exe](https://github.com/abod124-sudo/Radium-Launcher/releases/download/v3.5.3/Radium.Launcher_3.5.3_x64-setup.exe) | NSIS installer for Windows x64 |
